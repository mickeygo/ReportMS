...
namespace Gear.Infrastructure.Storage
{
    ...
    public interface IStorage
    {
        ...
        /// </param>
        /// <returns><c>T</c>集合</returns>
        IEnumerable<T> Select<T>(string sqlQuery, int start, int count, IDictionary<string, object> param);
        ...
        /// </param>
        /// <returns><c>T</c>集合</returns>
        IEnumerable<T> Select<T>(string sqlQuery, int start, int count, object param = null);
        ...
        /// </param>
        /// <returns><see cref="System.Data.Common.DbDataReader"/></returns>
        IDataReader GetDataReader(string sqlQuery, int start, int count, IDictionary<string, object> param);
        ...
        /// </param>
        /// <returns><see cref="System.Data.Common.DbDataReader"/></returns>
        IDataReader GetDataReader(string sqlQuery, int start, int count, object param = null);
