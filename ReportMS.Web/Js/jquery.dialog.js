...
/*
	tag eg:
	<element data-dialog="true" data-dialog-href="" data-dialog-title="" />

	form eg:
	<form data-ajax-form="true" data-ajax-begin="function" data-ajax-success="function" data-ajax-failure="function">
	</form>
*/
...
(function($) {
    var modalDialog = {
        ...
        show: function(element) {
            ...
            $(this.modalId + " .modal-body").load(this.href, function(data, status, xhr) {
                if (status === "error") {
                    $(this).text("Remote request fail, please try again.");
                } else {
                    var attach = element.attr("data-attachment");
                    if (attach) {
                        $(this).find("form input:submit").attr({ "data-attachment": attach });
                    }
